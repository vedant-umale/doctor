      ...
      <div className='flex items-center gap-4'>
        {token && userData ? (
          <div ref={dropdownRef} className='relative'>
            ...
            {showDropdown && (
              <div className='absolute top-10 right-0 min-w-48 bg-gray-50 rounded flex flex-col gap-4 p-4 z-50 shadow-md'>
                ...
                <p onClick={() => { logout(); setShowDropdown(false); }} className='hover:text-primary cursor-pointer'>Logout</p>
              </div>
            )}
          </div>
        ) : (
